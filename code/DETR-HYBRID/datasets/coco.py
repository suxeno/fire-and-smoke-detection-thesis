...
class CocoDetection(torchvision.datasets.CocoDetection):
    def __init__(self, img_folder, ann_file, transforms, return_masks, superpixel_paths=None):
...
def build(image_set, args):
    ...
    dataset = CocoDetection(img_folder, ann_file, transforms=make_coco_transforms(image_set), return_masks=args.masks, superpixel_paths=superpixel_paths)
    return dataset
